...
<?php include 'header.php';?>
    ...
    <section class="career_banner inner_banner_section">
        <div class="container">
    ...
    <div class="wrapp">
     ...
     <div class="display_flex align_center section-fadeleft buisness_section_container_left">
        ...
        <div class="col-md-6 buisness_section_img_left">
            <img class="width100" src="img/carrer_images1.jpg">
        </div>
    </div>
    
    <div class="anim-text__title main_about_heading"><h4 class="js-split-words2 fontsize42">BUILD YOUR POWERFUL CAREER</h4></div>
