                                                ...
                                                <div class="work__info">
                                                    <div class="work__left-bl">
                                                        ...
                                                        <p class="text_fotns mb-0 pb-0">
                                                            {{ \Carbon\Carbon::parse($projects['date'])->format('M d, Y') }}
                                                        </p>
                                                        <p class="text_fotns">{{ $projects['description'] }}</p>
                                                        <a href="projects-and-accreditations.php" class="work__link">Read
                                                            More</a>
                                                    </div>
                                                </div>
                                            @endforeach
                                                ...
                                                @foreach ($project as $index => $projecta)
                                                    @if (isset($projecta['image']))
                                                        <div class="work__photo-item">
                                                            <img src="{{ asset('storage/' . $projecta['image']) }}"
                                                                alt="">
                                                        </div>
                                                    @endif
                                                @endforeach
