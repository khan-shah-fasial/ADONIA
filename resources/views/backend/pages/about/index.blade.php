            ...
            <div class="card-body p-0">
                ...
                <div class="card m-3">
                    <div class="card-body">
                        ...
                        <form id="about_marque_form" action="{{ url(route('about.steps')) }}" method="post" enctype="multipart/form-data">
                            @csrf
                        ...
                        <form id="about_teamwork_form" action="{{ url(route('about.teamwork')) }}" method="post"
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group mb-3">
                                    <div class="col-sm-12">
                                        <div class="form-group mb-3">
                                            <label>Team Work Image <span class="red">*</span> <span class="font-size11">(Max file
                                                    size 80kb - 1125*196)</span></label>
                                            <input class="form-control" type="file" id="image" name="image[]">
                                        </div>
                                    </div>
                ...
                <div class="card m-3">
                    <div class="card-body">
                        ...
                        <form id="about_mnv_section_form" action="{{ url(route('about.mnv_section')) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="form-group mb-3">
                                    <label>Mission & Vision Image <span class="red">*</span> <span class="font-size11">(Max file
                                    size 80kb - 1125*196)</span></label>
                ...
                <div class="card m-3">
                    <div class="card-body">
                        ...
                        <form id="about_our_values_form" action="{{ url(route('about.our_values')) }}" method="post" enctype="multipart/form-data">
                            @csrf
